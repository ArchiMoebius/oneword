...
but you can't stop us all... after all, we're all alike.`.split(
      /[\s]/g
    ),
  replay: () => {
    OneWord.render(OneWord.last_canvas_id, OneWord.last_words);
  },
  render : (canvas_id, words) => {
    OneWord.last_canvas_id = canvas_id;
    OneWord.last_words = JSON.parse(JSON.stringify(words));
